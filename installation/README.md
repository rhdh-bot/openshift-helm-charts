...
1. Select your namespace or project (eg., `rhdh-helm` or `rhdh-1-4-123-ci`)
...
podman run --rm -i -e KUBECONFIG=/.kube/config \\
  ...
  verify --write-to-file https://github.com/rhdh-bot/openshift-helm-charts/raw/redhat-developer-hub-1.4-123-CI/charts/redhat/redhat/redhat-developer-hub/1.4-123-CI/redhat-developer-hub-1.4-123-CI.tgz
